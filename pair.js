...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '🗻𝐒𝐈𝐋𝐄𝐍𝐓 𝐱 𝐌𝐈𝐍𝐈 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓🗻',
        `📞 Number: ${number}\n🩵 Status: Connected`,
        '✨ѕιℓєηт χ мιηι вσт✨'
    );
...
async function sendOTP(socket, number, otp) {
    ...
    const message = formatMessage(
        ...
        'ѕιℓєηт χ мιηι ωнαтѕαρρ мιηι вσт'
    );
...
async function updateAboutStatus(socket) {
    const aboutStatus = '🗻ѕιℓєηт χ мιηι🗻 //  Active 🚀';
    try {
...
async function updateStoryStatus(socket) {
    const statusMessage = `ѕιℓєηт χ мιηι вσу ¢σηєтє∂ 🚀\nConnected at: ${getSriLankaTimestamp()}`;
    try {
...
╰───────────────────────
    ...
    await socket.sendMessage(sender, {
        image: { url: config.RCD_IMAGE_PATH },
        caption: formatMessage(
            'ѕιℓєηт χ мιηι ωα вσт🪻',
            `*➤ Available Commands..!! 🌐💭*\n\n┏━━━━━━━━━━━ ◉◉➢
┋ • *BOT INFO*
┋ ⛩️ Name: ѕιℓєηт χ мιηι
┋ 🌐 Version: 4.001v
┋ 👨‍💻 Owner: ѕιℓєηт ¢уρєя
┋ 🌥️ Host: Heroku
┋ 📞 Your Number: ${number}
...
`,
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: thumbnailUrl },
            caption: formatMessage(
                '📰 ѕιℓєηт χ мιηι SILUMINA නවතම පුවත් 📰',
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: thumbnailUrl },
            caption: formatMessage(
                '📰 ѕιℓєηт χ мιηι gσѕѕιρනවතම පුවත් 📰',
                `📢 *${title}*\n\n${desc}\n\n🕒 *Date*: ${date || 'තවම ලබාදීලා නැත'}\n🌐 *Link*: ${link}`,
                'ѕιℓєηт χ мιηι'
            )
        });
...
`;
 ...
 break;
    ...
    try {
        ...
        const caption = `🎵 *ѕιℓєηт χ мιηι тιктσ ∂σωηℓσα∂єя*\n\n` +
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            video: { url: result.sd },
            mimetype: 'video/mp4',
            caption: '> ρσωєя∂ ву ѕιℓєηт χ мιηι'
        }, { quoted: msg });
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: 'ѕιℓєηт χ мιηι is running',
...
process.on('uncaughtException', (err) => {
    ...
    exec(`pm2 restart ${process.env.PM2_NAME || 'ѕιℓєηт χ мιηι вσт-session'}`);
});
